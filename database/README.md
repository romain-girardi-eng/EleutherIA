...
- **191 corpus text cohorts** (Greek/Latin works and their translations) with CTS URN support where available
- **23,027 passages** with hierarchical structure (book/chapter/section)
