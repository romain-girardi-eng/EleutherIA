...
import { GitCompare, X, Check, AlertCircle, BookOpen } from 'lucide-react';
    ...
    <div className={`${className}`}>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">{t('comparisonTool.title')}</h2>
            <p className="text-sm text-gray-600">
              {t('comparisonTool.subtitle')}
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Common Comparisons */}
      <div className="mb-6">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">{t('comparisonTool.popularComparisons')}</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">
          {t('comparisonTool.selectEntities')}
        </h3>
          ...
          {selectedEntities.length < 4 && (
            <div className="relative flex-1 min-w-0 sm:min-w-[200px] w-full sm:w-auto">
              <input
                ...
                placeholder={t('comparisonTool.searchEntities')}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 min-h-[44px]"
              />
        ...
        >
          {isSearching ? t('comparisonTool.analyzing') : t('comparisonTool.compareButton', { count: selectedEntities.length })}
        </button>
      </div>
          ...
          >
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4">
                <h3 className="text-xl font-bold">{t('comparisonTool.comparisonMatrix')}</h3>
              </div>
            ...
            {comparisonResult.synthesis && (
              <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-6">
                <h3 className="flex items-center gap-2 text-lg font-bold text-indigo-900 mb-4">
                  ...
                  {t('comparisonTool.scholarlySynthesis')}
                </h3>
