      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-6 rounded-t-2xl">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold mb-2">{t('graphrag.argumentMapper.title')}</h2>
      ...
      <div className="bg-white rounded-b-2xl shadow-xl p-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-bold text-green-900">
                {t('graphrag.argumentMapper.premisesLabel')} ({argument.premises.length})
              </h3>
            </div>
            <motion.div
        ...
        <div className="flex justify-center mb-6">
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-gray-500 font-medium mt-1">{t('graphrag.argumentMapper.therefore')}</span>
          </div>
        </div>
        ...
        <div className="mb-6 p-6 bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-300 rounded-xl">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-indigo-900 mb-2">{t('graphrag.argumentMapper.conclusionLabel')}</h3>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-red-900">
                  {t('graphrag.argumentMapper.objectionsLabel')} ({argument.objections.length})
                </h3>
              </div>
              <motion.div
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-blue-900">
                  {t('graphrag.argumentMapper.responsesLabel')} ({argument.responses.length})
                </h3>
              </div>
              <motion.div
        ...
        <div className="mt-8 p-4 bg-gray-50 border border-gray-200 rounded-xl">
          <h4 className="font-semibold text-gray-900 mb-3 text-sm">{t('graphrag.argumentMapper.legendTitle')}</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">{t('graphrag.argumentMapper.premisesDesc')}</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-indigo-600" />
              <span className="text-gray-700">{t('graphrag.argumentMapper.conclusionDesc')}</span>
            </div>
            {argument.objections && argument.objections.length > 0 && (
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-red-600 text-white rounded-full flex items-center justify-center text-xs font-bold">O</div>
                <span className="text-gray-700">{t('graphrag.argumentMapper.objectionsDesc')}</span>
              </div>
            )}
            {argument.responses && argument.responses.length > 0 && (
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold">R</div>
                <span className="text-gray-700">{t('graphrag.argumentMapper.responsesDesc')}</span>
              </div>
            )}
          </div>
        </div>
