...
export default function InfluenceFlowDiagram() {
  ...
  const matrixData = useMemo(() => {
    if (!influenceMatrix || !influenceMatrix.cells || !Array.isArray(influenceMatrix.cells)) return null;
    if (!influenceMatrix.rows || !Array.isArray(influenceMatrix.rows)) return null;
    if (!influenceMatrix.columns || !Array.isArray(influenceMatrix.columns)) return null;
