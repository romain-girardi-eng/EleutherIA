          ...
          <div className="space-y-6 text-stone-600 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 min-h-11 px-4 py-2 bg-parchment-50 backdrop-blur-sm text-orange-600 rounded-full border border-amber-200 hover:shadow-md transition-all text-sm"
              >
