      ...
      <section className="academic-card">
        ...
        <div className="space-y-4 text-academic-text leading-relaxed">
          ...
          <p>
            ...
            465 philosophical entities (persons, works, concepts, arguments) connected through 740 relationships, alongside
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-academic-bg p-4 rounded">
              ...
              <ul className="text-sm space-y-1">
                <li>• 465 entities verified against ancient sources</li>
                <li>• 740 relationships documented with citations</li>
                <li>• 289 texts with lemmatization (Greek/Latin)</li>
                <li>• 200+ modern scholarship references</li>
