      ...
      <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('credits.dataSources')}</h2>
          </div>

          <div className="space-y-6">
            {/* Perseus Digital Library */}
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
              <h3 className="text-xl font-bold text-blue-900 mb-3">{t('credits.perseus')}</h3>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/PerseusDL/canonical-greekLit" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/PerseusDL/canonical-latinLit" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
              <h3 className="text-xl font-bold text-purple-900 mb-3">{t('credits.scaife')}</h3>
              <p className="text-sm text-gray-700 mb-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <a href="https://scaife.perseus.org" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline">
                      scaife.perseus.org
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
              <h3 className="text-xl font-bold text-green-900 mb-3">Open Greek and Latin Project - CSEL Corpus</h3>
              <p className="text-sm text-gray-700 mb-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <a href="https://github.com/OpenGreekAndLatin/csel-dev" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('credits.techInfra')}</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Visualization */}
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border border-indigo-200">
              <h3 className="text-lg font-bold text-indigo-900 mb-3">{t('credits.vizTools')}</h3>
            ...
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-6 border border-violet-200">
              <h3 className="text-lg font-bold text-violet-900 mb-3">{t('credits.frontendFramework')}</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6 border border-pink-200">
              <h3 className="text-lg font-bold text-pink-900 mb-3">{t('credits.backendServices')}</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-200">
              <h3 className="text-lg font-bold text-amber-900 mb-3">UI Components</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('credits.standards')}</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
              <h3 className="text-lg font-bold text-blue-900 mb-2">Canonical Text Services (CTS)</h3>
              <p className="text-sm text-gray-700 mb-3">
                Standard for citing and retrieving ancient texts using URN-based identifiers
              </p>
              <a href="http://cite-architecture.github.io/cts/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-sm">
                cite-architecture.github.io/cts/
              </a>
            </div>

            <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-xl p-6 border border-green-200">
              <h3 className="text-lg font-bold text-green-900 mb-2">FAIR Data Principles</h3>
              <p className="text-sm text-gray-700 mb-3">
                Findable, Accessible, Interoperable, Reusable
              </p>
              <a href="https://www.go-fair.org/fair-principles/" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline text-sm">
                go-fair.org/fair-principles/
              </a>
            </div>

            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6 border border-purple-200">
              <h3 className="text-lg font-bold text-purple-900 mb-2">JSON Schema</h3>
              <p className="text-sm text-gray-700 mb-3">
                Database structure validated against JSON Schema Draft 07
              </p>
              <a href="https://json-schema.org/" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline text-sm">
                json-schema.org
              </a>
            </div>

            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 border border-orange-200">
              <h3 className="text-lg font-bold text-orange-900 mb-2">TEI (Text Encoding Initiative)</h3>
              <p className="text-sm text-gray-700 mb-3">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">{t('credits.projectLicense')}</h2>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-xl border border-blue-200">
            <div className="flex items-start gap-4 mb-6">
              ...
              />
              <div>
                <h3 className="font-bold text-2xl text-blue-900 mb-2">{t('credits.ccBy4')}</h3>
            ...
            <div className="space-y-4 text-sm text-gray-800">
              <div>
                <strong className="text-blue-900">You are free to:</strong>
              ...
              <div>
                <strong className="text-blue-900">Under these terms:</strong>
                <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
              ...
              <div className="mt-6 pt-4 border-t border-blue-200">
                <strong className="text-blue-900">Suggested Citation:</strong>
                <div className="mt-2 bg-white p-4 rounded-lg border border-blue-300 font-mono text-xs">
        ...
        <motion.div
          ...
          className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-sm"
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{t('credits.acknowledgments')}</h2>
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p className="mt-6 text-gray-600 italic bg-blue-50 p-4 rounded-xl border border-blue-200">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-50 to-indigo-50 backdrop-blur-sm rounded-2xl p-6 border border-blue-200 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Report Issues or Suggest Corrections</h2>
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-full hover:shadow-lg transition-all"
            >
              Contact via Email
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-700 rounded-full border border-gray-300 hover:shadow-md transition-all"
            >
              Open GitHub Issue
            </a>
          </div>
