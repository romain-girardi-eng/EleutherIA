...
export default function ChatInput({
  ...
  return (
    <div className="shrink-0 px-4 xl:px-10 2xl:px-16 py-3 xl:py-4 border-t border-amber-200/40 bg-parchment-50/80 backdrop-blur-sm">
      <div className="rounded-xl border border-stone-300 bg-parchment-50 focus-within:border-orange-700 focus-within:ring-2 focus-within:ring-orange-700/15">
        <form onSubmit={onSubmit} className="p-2">
          <div className="flex flex-wrap items-end gap-2">
            ...
            <textarea
              ...
              aria-label={t('graphRagUi.welcome.question')}
              placeholder={t('graphrag.placeholder')}
              className="flex-1 min-w-0 px-4 sm:px-6 py-3 xl:py-4 text-base xl:text-base 2xl:text-lg bg-transparent focus:outline-none focus:ring-0 border-0 resize-y"
            />
            {streaming && (
              <button
                type="button"
            ...
            <button
              ...
              className="px-4 sm:px-6 py-3 xl:py-4 min-h-[44px] bg-orange-800 text-orange-50 rounded-lg hover:bg-orange-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all font-medium text-sm xl:text-base"
            >
              {t('graphrag.ask')}
            </button>
          </div>
