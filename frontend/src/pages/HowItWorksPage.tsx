...
import {
  Network, Search, BookOpen, ChevronRight,
...
export default function HowItWorksPage() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main
        ref={containerRef}
        className={`min-h-screen overflow-y-auto scroll-smooth transition-[margin] duration-300 ease-out relative z-10 pt-16
          ${isMenuCollapsed ? 'lg:ml-[72px]' : 'lg:ml-64'}`}
      >
        {/* GitHub banner at top */}
        ...
        <section id="hirag" className="py-20 px-6 bg-white/60 backdrop-blur-sm">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Two-column Philological Work + Technical Infrastructure */}
        ...
        {/* HiRAG Implementation Details Section */}
