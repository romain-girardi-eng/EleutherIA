...
| C — Doxographic foundations | completed | scripts/wave_c_doxographic_foundations_2026_05_16.py | _pending_ | collections_added=4 (collection_aetius_placita, collection_dk, collection_ls, collection_dox_graeci_diels) ; publications_added=1 (pub_amand_1973_fatalisme_liberte — Hakkert 1973 reprint of Amand 1944 Louvain thesis, eponym of 2026-05-16-pre-amand-coherence-patches snapshot) ; amand_eponym_added=True ; nodes 19,855 → 19,860 ; SHACL invariants Conforms=True ; mypy strict + ruff clean ; idempotent (2nd run zeros) |
