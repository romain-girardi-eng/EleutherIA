...
NODES_PER_CHUNK = 8
CANDIDATES_PATH = CAMPAIGN_DIR / "candidates_school_pw.jsonl"
RESULTS_PATH = CAMPAIGN_DIR / "results_school_pw.jsonl"
ERRORS_PATH = CAMPAIGN_DIR / "errors_school_pw.jsonl"
...
async def main() -> None:
    ...
    map_path = CAMPAIGN_DIR / "chunks_map_school_pw.jsonl"
