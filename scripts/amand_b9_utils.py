"""Utilities for Amand B9 consolidation (Livre II patristiques secondaires).

Targets : Justin Ch. I + Tatien note, Irénée Ch. II + Hippolyte note, Bardesane Ch. III,
Clément Ch. IV, Méthode Ch. VI, Épiphane Ch. X, Diodore de Tarse Ch. XI, Commentateur
arien de Job Ch. XIII.

Same shape as amand_b7_utils / amand_b8_utils.
"""
