...
`/Users/romaingirardi/SematikaData/Extracted/Philocalia.txt` contains a clean
...
SEMATIKA_PHILOC = Path("/Users/romaingirardi/SematikaData/Extracted/Philocalia.txt")
